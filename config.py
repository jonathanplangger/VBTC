...
_C.DB.RUGD.IMG_DIR = "RUGD_frames-with-annotations" # Name of the directory containing RGB coloured images, default as downloaded from the source site
_C.DB.RUGD.ANN_DIR = "RUGD_annotations" # Name of the annotations directory, default as downloaded from the source site
_C.DB.RUGD.MODIF_ANN_DIR = "RUGD_modif_frames-with-annotations" # Name of the modified (re-mapped) annotations files (Uses 0->N_classes - 1 instead of {0,255})
_C.DB.RUGD.COLOR_MAP = "RUGD_annotation-colormap.txt" # Name of the colour/class map file provided by the dataset
